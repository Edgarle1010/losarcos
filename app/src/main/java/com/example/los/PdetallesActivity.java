...
public class PdetallesActivity extends AppCompatActivity implements OnItemSelectedListener {
...
String sub;
    ...
    public void menu(View t) {
        Intent intent = new Intent(PdetallesActivity.this, CarritoActivity.class);
